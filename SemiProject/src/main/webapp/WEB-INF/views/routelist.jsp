...
<body>
		...
		<div class="get">
			<span> <span class="postbtn"><a href="todaylist">오늘의
							러닝</a></span> <span class="postbtn"><a href="routelist"><b>코스공유</b></a></span> <span
	...
	<h2	style="font-size: 25px; text-align: center; margin-top: 40px; color: green">코스 공유</h2>
		<table >
	...
	<c:forEach var="route" items="${routelist}">
					<tr style="border-bottom: 1px solid #D3D3D3;">
	    				...
	    				<td style="text-align: center;"><a href="/routepost?articleNo=${route.route_articleNo}">${route.route_title}</a></td>
		 				<td style="text-align: center;">${route.route_date}</td>
					</tr>
					</c:forEach>
					</table>
	<c:choose>
		...
		<c:when test="${routelist!=null && pageInfo.listCount>0 }">
			...
			<c:choose>
				...
				<c:otherwise>
					<a href="routelist?page=${pageInfo.page-1}">«&nbsp;</a>
				</c:otherwise>
			</c:choose>
		...
		<c:otherwise>
			<tr>
				<td colspan="3"><b style="text-align: center;">작성한 글이 없습니다.</b></td>
			</tr>
		</c:otherwise>
	</c:choose>
