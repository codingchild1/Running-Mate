	...
	<div style="width: 1060px; padding: 10px; margin: 20px auto;">
		...
		<div style="width: 700px; margin: 60px; margin-left: 120px;">
			...
			<div style="margin: 25px; display: flex;">
				...
				<input id="input" type="text"style="width: 500px; height: 40px; margin-left: 10px; font-size: 15px;"placeholder="검색어를 입력하세요.">
			</div>
			...
			<div style="font-size: 13px; float: right; display: flex;">
				<form action="mate_updatemate" method="get">
					<span id="update">
						...
						<input type="submit" value='수정'style="border: none; background-color: rgba(123, 173, 213, 0.70); cursor: pointer; margin: 5px;">
					</span>
				</form>
				<span id="delete" style="margin: 5px;"><button class="delete"style="border: none; background-color: rgba(123, 173, 213, 0.70); cursor: pointer;">삭제</button></span>
		...
		<div class="modal-window">
			...
			<div style="font-size: 13px; float: right; display: flex;">
				<form action="mate_updategroup" method="get">
					<span id="update2"><input type="hidden" id="ptp" name="ptp"	value=''><input type="submit" value='수정'style="border: none; background-color: rgba(123, 173, 213, 0.70); cursor: pointer; margin: 4px;"></span>
				</form>
				<span id="delete2" style="margin: 5px; cursor: pointer;">
				<button class="delete2"style="border: none; background-color: rgba(123, 173, 213, 0.70); cursor: pointer;">삭제</button></span>
				<span style="margin: 5px;"><button class="repoprt"style="border: none; background-color: rgba(123, 173, 213, 0.70); cursor: pointer;">신고</button></span>
			</div>
