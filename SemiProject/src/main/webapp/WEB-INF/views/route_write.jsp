	...
	<main style="width: 70%; margin: 0 auto;">
		...
		<div><form id="route_write" action="/route_reg" method="post">
			<div id="user_info" style="height:80px; display: flex; align-items: center;">
				...
				<div id="user_id" style="height:40px; display:inline-block; line-height: 40px; padding-left : 10px;" >고길동</div>
			</div>
			<input type="text" id="route_title" name="route_title" class="form-control mt-1" value="제목"/><br>
			<p>코스를 그려주세요</p>
			<div id="map"></div>
			<div style="text-align:center; margin-top:20px; margin-bottom:20px;">
				<input type="submit" value="등록" style="width:15%; display:inline-block;" class="btn btn-dark"/>
				<input id="reset" type="reset" value="취소" style="width:15%; display:inline-block;" class="btn btn-dark"/>
			</div>
		</form></div>
	</main>
	<script>
