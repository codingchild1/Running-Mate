...
<body>
	...
	<div class="container" style="padding-top: 1em;">
		<h2>게시판 등록</h2>
		<form action="boardmodify" method="post" name="fb_modify">
		<input type="hidden" id="form_writer" name="writer">
		<input type = "hidden" name = "fb_articleNo" value = "${article.fb_articleNo}"/>
		<div>
			<div class="writing_title">
				<input type="text" id="title" name="fb_title" style="width: 100%; height: 30px; margin: 15px 0 15px 0;" value = "${article.fb_title}"/>
			</div>
		</div>
		
			<div class="board_detail">
					<textarea  id="editor" name="fb_content">${article.fb_content}</textarea>
			</div>
			<div class="writebtn">
