			...
			<div style="margin-top: 100px;">
				<div style="display: flex; align-items: center;">
					<span><img class="profile" src='${mate.user_img }'id="user_img2"></span>
						<input type="hidden" name="user_img"id="user_img" value=""> <span><input type="text"id="user_id" name="user_id" value='${mate.user_id }'style="height: 20px; border: none; background-color: white;"disabled> </span>
				...
				<div id="mapinfo"style="border: 1px solid; width: 250px; height: 250px; margin-top: 20px;"></div>
					...
					<input type="hidden"id="mate_address" name="mate_address" value='${mate.mate_address }'>
